...
https://canva.link/c0qc86hi4mibvp6

### Reflection

* Did the topics discussed in your labs prepare you to complete the assignment? Be specific, which features in your weekly assignment did you feel unprepared to complete?

The labs gave me a strong foundation for building React components, working with API requests, and structuring backend routes. I felt most prepared for core CRUD and state management flows. The part that felt less familiar at first was coordinating the full checkout/order flow across frontend and backend (especially keeping UI state in sync with route changes), but I got more comfortable with it after debugging and iterating.

* If you had more time, what would you have done differently? Would you have added additional features? Changed the way your project responded to a particular event, etc.
  
With more time, I would add automated tests for both API endpoints and key frontend user flows (cart updates, checkout, and order detail navigation). I would also improve API error messaging and add loading/empty/error states in a few more places for a more polished user experience.

* Reflect on your project demo, what went well? Were there things that maybe didn't go as planned? Did you notice something that your peer did that you would like to try next time?

What went well was the end-to-end demo of browsing products, adding items to cart, placing an order, and viewing order history/details. One thing that did not go perfectly at first was the sidebar behavior after checkout, but debugging that helped me better understand shared state and component interactions. In a future project, I want to adopt the more test-driven workflow I saw from peers so issues can be caught earlier.
...
Shout out to my co-interns, instructors, and manager for all the emotional support. 